    ...
    <div className="flex flex-col h-full bg-[#1c1c1a] rounded-2xl border border-[#e8e6dc20] overflow-hidden">
      ...
      <div className="flex-1 overflow-y-auto p-6 space-y-5">
        <div className="text-center space-y-2">
          <h1 className="text-5xl font-bold text-[#d97757] font-poppins tracking-wider">
            {entry.id}
          </h1>
          <p className="text-xl text-[#faf9f5] font-lora leading-snug">{entry.fullName}</p>
          ...
          <div className="bg-[#141413] rounded-xl p-4">
            <div className="flex items-start gap-2">
              ...
              <div>
                ...
                <p className="text-[#faf9f5] text-sm font-lora leading-relaxed">{entry.mnemonic}</p>
              </div>
            </div>
          </div>
          ...
          <div className="bg-[#141413] rounded-xl p-4">
            <div className="flex items-start gap-2">
              ...
              <div>
                ...
                <p className="text-[#faf9f5] text-sm font-lora leading-relaxed">{entry.realWorldExample}</p>
              </div>
            </div>
          </div>
          ...
          <div className="bg-[#141413] rounded-xl p-4">
            <div className="flex items-start gap-2">
              ...
              <div>
                ...
                <p className="text-[#faf9f5] text-sm font-lora leading-relaxed">{entry.examTip}</p>
              </div>
            </div>
          </div>
            ...
            <div className="bg-[#141413] rounded-xl p-4">
              <div className="flex items-start gap-2">
                ...
                <div>
                  ...
                  <p className="text-[#faf9f5] text-sm font-lora">{entry.confusedWith.join(', ')}</p>
                </div>
              </div>
            </div>
          )}
      ...
      <BottomSheet isOpen={explainOpen} onClose={() => setExplainOpen(false)} title="Different Explanation">
        {loadingExplain ? (
          ...
          <p className="text-[#faf9f5] font-lora leading-relaxed">{explanation}</p>
        )}
      </BottomSheet>
    </div>
  )
